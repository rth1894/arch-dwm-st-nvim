...
static const char *fonts[]          = { "Nimbus Sans:size=13" };
static const char dmenufont[]       = "Nimbus Sans:size=13";
...
static const char *save[] = { "/bin/sh", "-c", "maim -s ~/Pictures/$(date +%F-%H_%M_%S).png", NULL };
